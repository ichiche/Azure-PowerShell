...
$VaultName = "RecoveryServiceVault" #fetch automatically
$Subscription = "ES-CE-LR-INT chicheng" #fetch automatically
$ResourceGroup = "Backup" #fetch automatically
$SubscriptionId = "7a2dec40-395f-45a9-b6b0-bef1593ce760" #fetch automatically
